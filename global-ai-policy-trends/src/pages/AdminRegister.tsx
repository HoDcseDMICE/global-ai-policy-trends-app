    ...
    <div className="min-h-[80vh] flex items-center justify-center relative">
      ...
      >
        <div className="glass-panel p-8 rounded-2xl border border-white/10 shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 left-0 w-32 h-32 bg-red-500/10 blur-[50px] -z-10" />
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-display font-bold text-white mb-2">Admin Registration</h2>
            <p className="text-slate-400 text-sm">Create an Administrator Account</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            >
              <span className="absolute inset-0 bg-gradient-to-r from-red-500 to-rose-500 rounded-xl opacity-70 group-hover:opacity-100 transition-opacity duration-300"></span>
              <div className="relative bg-[#020617] px-4 py-3 rounded-xl flex items-center justify-center gap-2 transition-all duration-300 group-hover:bg-opacity-0 group-hover:text-white">
                {loading ? (
                  ...
                  <>
                    <span className="font-semibold text-slate-200 group-hover:text-white transition-colors">Register Admin</span>
          ...
          <p className="mt-8 text-center text-sm text-slate-400">
            ...
            <Link to="/login/admin" className="text-red-400 hover:text-white font-medium transition-colors">
              Sign in
            </Link>
          </p>
        </div>
